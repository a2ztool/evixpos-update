...
const ALL_LANDING_KEYS: Record<string, { key: string; type: "text" | "image"; defaultValue: string }[]> = {
  ...
  hero: [
    ...
    { key: "hero_social_proof_cta", type: "text", defaultValue: "Join" },
    { key: "hero_browser_url", type: "text", defaultValue: "app.evixpos.com" },
    { key: "hero_image_alt", type: "text", defaultValue: "EvixPOS Dashboard" },
    { key: "hero_card_revenue_label", type: "text", defaultValue: "Revenue Today" },
    { key: "hero_card_revenue_value", type: "text", defaultValue: "৳42,580" },
    { key: "hero_card_orders_label", type: "text", defaultValue: "New Orders" },
    { key: "hero_card_orders_value", type: "text", defaultValue: "+24" },
  ...
  mobile: [
    ...
    { key: "mobile_btn_android", type: "text", defaultValue: "Google Play" },
    { key: "mobile_btn_ios", type: "text", defaultValue: "App Store" },
    { key: "mobile_btn_install", type: "text", defaultValue: "Install App" },
    { key: "mobile_btn_web", type: "text", defaultValue: "Use Web App" },
    { key: "mobile_btn_browser", type: "text", defaultValue: "Open in Browser" },
    { key: "mobile_btn_installed", type: "text", defaultValue: "App Installed" },
  ...
  pricing: [
    ...
    { key: "pricing_volume_label", type: "text", defaultValue: "Customer Volume" },
    { key: "pricing_monthly_label", type: "text", defaultValue: "Monthly" },
    { key: "pricing_yearly_label", type: "text", defaultValue: "Yearly" },
    { key: "pricing_yearly_save_badge", type: "text", defaultValue: "Save 20%" },
    { key: "pricing_popular_badge", type: "text", defaultValue: "POPULAR" },
    { key: "pricing_best_value_badge", type: "text", defaultValue: "BEST VALUE" },
    { key: "pricing_yearly_off_badge", type: "text", defaultValue: "20% OFF" },
    { key: "pricing_validity_monthly", type: "text", defaultValue: "Valid: 30 days" },
    { key: "pricing_validity_yearly", type: "text", defaultValue: "Valid: 365 days" },
    { key: "pricing_volume_ticks", type: "text", defaultValue: "500|1K|5K|10K|20K|50K|100K" },
    { key: "plan_unit_stores", type: "text", defaultValue: "stores" },
    { key: "plan_unit_products", type: "text", defaultValue: "products" },
    { key: "plan_free_period", type: "text", defaultValue: "/forever" },
    { key: "plan_period_monthly", type: "text", defaultValue: "/mo" },
    { key: "plan_period_yearly", type: "text", defaultValue: "/yr" },
    { key: "plan_free_name", type: "text", defaultValue: "Free" },
    { key: "plan_free_tagline", type: "text", defaultValue: "Forever free" },
    { key: "plan_free_cta", type: "text", defaultValue: "Start Free" },
    { key: "plan_pro_name", type: "text", defaultValue: "Pro" },
    { key: "plan_pro_tagline", type: "text", defaultValue: "Best for growing businesses" },
    { key: "plan_pro_cta", type: "text", defaultValue: "Get Started" },
    { key: "plan_pro_cta_logged_in", type: "text", defaultValue: "Upgrade Now" },
    { key: "plan_business_name", type: "text", defaultValue: "Business" },
    { key: "plan_business_tagline", type: "text", defaultValue: "For scaling teams" },
    { key: "plan_business_cta", type: "text", defaultValue: "Get Started" },
    { key: "plan_business_cta_logged_in", type: "text", defaultValue: "Upgrade Now" },
    { key: "plan_custom_visible", type: "text", defaultValue: "true" },
    { key: "plan_custom_name", type: "text", defaultValue: "Custom" },
    { key: "plan_custom_tagline", type: "text", defaultValue: "For large businesses" },
    { key: "plan_custom_price_label", type: "text", defaultValue: "Custom" },
  ...
  footer: [
    ...
    { key: "social_facebook", type: "text", defaultValue: "https://facebook.com/evixpos" },
    { key: "social_instagram", type: "text", defaultValue: "https://instagram.com/evixpos" },
    { key: "social_youtube", type: "text", defaultValue: "https://youtube.com/@evixpos" },
    ...
    { key: "footer_link_integrations", type: "text", defaultValue: "Integrations" },
    { key: "footer_link_updates", type: "text", defaultValue: "What's New" },
    { key: "footer_link_demo", type: "text", defaultValue: "Request Demo" },
    { key: "footer_link_privacy", type: "text", defaultValue: "Privacy" },
    { key: "footer_link_terms", type: "text", defaultValue: "Terms" },
    { key: "footer_link_refund", type: "text", defaultValue: "Refund Policy" },
    { key: "footer_link_billing", type: "text", defaultValue: "My Plan" },
    { key: "footer_link_support", type: "text", defaultValue: "Support" },
    { key: "footer_link_whatsapp", type: "text", defaultValue: "WhatsApp Us" },
    { key: "footer_link_email", type: "text", defaultValue: "Email Us" },
